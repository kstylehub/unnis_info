        ...
        <div className="top-0 sticky w-full z-20 bg-white pt-2 shadow">
          ...
          <div className="border-t pt-2">
            <div className="flex justify-center text-center">
              <div
                className={`w-4/12 hover:border-b-2 hover:border-black pb-2 cursor-pointer ${
                  selectedCategory === 1 ? "border-b-2 border-black" : ""
                }`}
              ...
              <div
                className={`w-4/12 hover:border-b-2 hover:border-black pb-2 cursor-pointer ${
                  selectedCategory === 2 ? "border-b-2 border-black" : ""
                }`}
              ...
              <div
                className={`w-4/12 hover:border-b-2 hover:border-black pb-2 cursor-pointer ${
                  selectedCategory === 3 ? "border-b-2 border-black" : ""
                }`}
              ...
              <div
                className={`w-4/12 hover:border-b-2 hover:border-black pb-2 cursor-pointer ${
                  selectedCategory === 4 ? "border-b-2 border-black" : ""
                }`}
