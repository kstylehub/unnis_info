...
function MyPage () {
    return (
        <>
        <div className="bg-white h-full w-[100%] py-6 ">
            <div className="px-2 pb-5">
                <div className="justify-center items-center">
                    <p className="flex justify-center items-center lg:text-xl text-lg">MY PAGE</p> 
                </div> 
            </div>
            ...
            <div className="flex py-3 mt-1 px-5 flex items-center justify-between w-full bg-gray-200">
                ...
                <div className="flex flex-row justify-center items-center">
                   <div className="mx-3 text-[#4ABFA1] text-sm font-bold">
                    ...
                    <svg class="w-2 h-2 text-[#4ABFA1] dark:text-[#4ABFA1]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
                        <path stroke="#4ABFA1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1"/>
                    </svg> 
                </div>
            </div>
            ...
            <div className="flex justify-center item-center bg-gray-200 py-0.5 pb-1 text-center">
                <div className="flex flex-col w-3/12 justify-center item-center bg-white mr-1 py-2">
                    ...
                    <div className="text-[#4ABFA1] text-sm flex justify-center">1</div>
                </div>
                <div className="flex flex-col w-3/12 justify-center item-center bg-white py-2">
                    <div className="flex justify-center item-center">
                        <img src={mark} className="w-3/12"/> 
                    </div>
                    <div className="text-xs">Postingan <br></br>Favorit</div>
                    <div className="text-[#4ABFA1] text-sm flex justify-center ">1</div>
                </div>
            ...
            <div className="flex flex-col w-full bg-gray-200 pb-1">
                ...
                <div className="flex py-3 px-5 flex items-center justify-between w-full bg-white">
                    ...
                    <div className="flex flex-row justify-center items-center">
                        <svg class="w-2 h-2 text-[#4ABFA1] dark:text-[#4ABFA1]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
                            <path stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1"/>
                        </svg> 
                    </div>
                </div>
            </div>
