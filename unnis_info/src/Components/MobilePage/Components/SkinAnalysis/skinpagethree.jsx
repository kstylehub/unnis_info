...
import girlthree from "../../../../assets/SkinAnalysis/girl_page_three.png";
import girltemplate from "../../../../assets/SkinAnalysis/girl_template.png";

function SkinPageThree () {
    return (
        <>
        <div className="py-12">
            <div className="flex flex-col text-center justify-center items-center">
                ...
                <div className="font-semibold text-base py-6 text-center">
                    Apakah kulitmu pernah muncul jerawat, gatal-
                    gatal, atau perih saat menggunakan skincare baru?
                </div>
                <div className="mt-3 flex justify-between w-full px-2">
                    <img src={girlthree} className="w-3/12" />
            ...
            <div className="flex items-center px-10 mt-5">
                ...
                <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-400"></div>
                <div className="flex items-center relative">
                    <input defaultChecked id="skinpageone" type="radio" value="" name="skinpageone-group" className="accent-teal-600 w-4 h-4 bg-[#4ABFA1] border-gray-400 "></input>
        ...
        <div className="flex flex-col">
            <Link to={"/skinsectiontwo/pagetwo"}>
