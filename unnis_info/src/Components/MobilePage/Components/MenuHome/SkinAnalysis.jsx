        ...
        <>
            <div className="absolute py-4 w-full h-full bg-[#FAE1E7] lg:px-8 px-4">
                <div className="flex justify-between sticky ">
                    ...
                    <div className="self-center">
                        <img src={camera} className="w-full h-auto" onClick={handleCameraClick} /> 
                    </div>
                </div>
                <div className="lg:my-12 my-6 mx-4 flex flex-col text-center justify-center items-center">
                    <h1 className="lg:text-3xl text-2xl font-bold my-4">Skin Analysis Test</h1>
                    <p className="lg:text-base text-sm font-medium mb-8">Analisa masalah kulitmu dan dapatkan rekomendasi produk sesuai jenis kulit!</p>
                    ...
                    <div className="flex justify-center my-8">
                        ...
                        <button className="bg-white rounded-lg mx-1 lg:font-base text-sm font-semibold px-10 py-2 drop-shadow-md"
